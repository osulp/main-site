...
namespace Drupal\osu_migrations_seagrant\Plugin\migrate\process;
 ...
 * )
 */
class GridLayout extends ProcessPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function transform($value, MigrateExecutableInterface $migrate_executable, Row $row, $destination_property) {
    ...
    foreach ($value as $item) {
      $block_id = $this->migrateLookup->lookup('paragraph_grid_item__to__layout_builder', [$item['value']]);
