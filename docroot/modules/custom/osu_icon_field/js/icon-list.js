...
const iconSizes = [
  { class: '', label: 'Default' },
  { class: 'fa-2x', label: 'Small' },
  { class: 'fa-3x', label: 'Medium' },
  { class: 'fa-5x', label: 'Large' },
  { class: 'fa-7x', label: 'Extra Large' },
];

module.exports = { osuIconNames, faIconNames, faBrandIconsNames, iconSizes };
